...
public class ActionsData {
    ...
    private static final List<Action> LAYOUT_ACTIONS_DATA = Arrays.asList(
            ActionDto.ofLayout("Grid 1"),
            ActionDto.ofLayout("Grid H2"),
            ActionDto.ofLayout("Grid V2"),
            ActionDto.ofLayout("Grid 4")
    );

    private static final List<Action> TERM_VIEW_ACTIONS_DATA = Arrays.asList(
            ActionDto.ofTermView("Terminal Panel 1"),
