 ...
 */
public class PuttyPaneImpl extends JPanel implements PuttyPane {
    ...
    public PuttyPaneImpl(final String host, final String user, final String port, final String password) {
    ...
    public void init() {
        term = new TerminalWin(PuttyPaneImpl.this, props, true);
        ...
        client.setDialogParent(PuttyPaneImpl.this);
        ...
        console.setOwnerContainer(PuttyPaneImpl.this);
